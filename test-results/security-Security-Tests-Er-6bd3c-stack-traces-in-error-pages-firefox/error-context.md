...
- Name: security.spec.ts >> Security Tests >> Error Handling Security >> should not expose stack traces in error pages
- Location: e2e/security.spec.ts:330:5
...
Call log:
  - navigating to "http://localhost:3000/movie/999999999", waiting until "load"
