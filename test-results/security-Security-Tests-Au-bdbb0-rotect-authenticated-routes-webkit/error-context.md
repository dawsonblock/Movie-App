...
- Name: security.spec.ts >> Security Tests >> Authentication Security >> should protect authenticated routes
- Location: e2e/security.spec.ts:173:5
...
Call log:
  - Expect "toHaveURL" with timeout 5000ms
    7 × unexpected value "http://localhost:3000/profile"
...
- main:
  - heading "404" [level=1]
  - heading "Not Found" [level=4]
  - paragraph: The page you are looking for doesn't exist.
  - button "Home"
- alert
```
