...
- Name: security.spec.ts >> Security Tests >> Open Redirect Prevention >> should prevent open redirect via next parameter
- Location: e2e/security.spec.ts:275:5
...
Call log:
  - navigating to "http://localhost:3000/auth/callback?next=https://evil.com", waiting until "load"
